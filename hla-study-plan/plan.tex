...
construction/indexing, and cluster runs. Owners below are proposed.
...
\midrule
\textbf{1} & \textbf{Dawn + agents:} panel QC, graph build/indexes, subset jobs.
\textbf{Hassan + agents:} experimental truth, read extraction, three typer
wrappers. \textbf{Robert + agents:} scoring, inference prototype, experiment
manifest.
...
\addlinespace
\textbf{2} & \textbf{Dawn:} mapping and subset runs.
\textbf{Hassan:} typing and paired evaluation.
\textbf{Robert:} error review and inference validation.
\textbf{Agents:} expand job arrays, test the prototype, and analyse existing bundles
while compute runs.
...
\addlinespace
\textbf{3} & \textbf{All three owners + agents:} complete runs, inspect discordant
